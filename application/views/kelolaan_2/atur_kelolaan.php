    ...
    <div id="navbar" class="navbar navbar-default    navbar-collapse       h-navbar ace-save-state">
     ...
     <div class="main-container ace-save-state" id="main-container">
      <script type="text/javascript">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="panel panel-default">
                            ...
                            <form class="form-horizontal" action="<?php echo site_url('Kelolaan/Atur');?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select name="cabang" id="capem" class="cabang form-control">
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>Capem Bank</label>
                                    <select name="id_capem_bank"  class="capem form-control">
                                        <option value="0">-PILIH CAPEM BANK-</option>
                                    </select>
                                </div>
                                <!--  <div class="form-group">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $('#bank').change(function(){
                    var id=$(this).val();
                    $.ajax({
                        url : "<?php echo base_url();?>kelolaan/get_cabang",
                        method : "POST",
                        data : {id: id},
                        async : false,
                        dataType : 'json',
                        success: function(data){
                            ...
                            for(i=0; i<data.length; i++){
                                html += '</option>'+'<option value='+data[i].id_cabang_bank+'>'+data[i].cabang_bank+'</option>';
                            }
                            $('.cabang').html(html);
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $('#capem').change(function(){
                    var capem=$(this).val();
                    $.ajax({
                        url : "<?php echo base_url();?>kelolaan/get_capem",
                        method : "POST",
                        data : {capem: capem},
                        async : false,
                        dataType : 'json',
                        success: function(data){
                            ...
                            var i;
                            for(i=0; i<data.length; i++){
                                html += '<option value='+data[i].id_capem_bank+'>'+data[i].capem_bank+'</option>';
                            }
                            $('.capem').html(html);
                        }
                    });
