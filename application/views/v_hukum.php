        ...
        <div class="main-content-inner">
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <button class="btn btn-md btn-success"><b>Unduh Excel</b></button> <button class="btn btn-md btn-warning"><b>Print Progress</b></button>
                <hr />
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            <tr class="gradeU">
                                                ...
                                                <td><span class="badge badge-warning">A-Care</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
