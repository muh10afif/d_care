            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('admin/manager');?>">Debitur Potensial</a></li>
                        <li class="breadcrumb-item"><a href="<?php echo base_url('manager/tasklist');?>">Task List</a></li>
  ...
  <div class="row">
      <div class="col-12">
          <div class="card border-info">
              <div class="card-body">
                  <form class="form-horizontal" method="post" action="<?php echo base_url('manager/act_tasklist');?>">
