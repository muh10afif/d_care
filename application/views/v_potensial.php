        ...
        <div class="main-content-inner">
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <button class="btn btn-md btn-success"><b>Unduh Excel</b></button> <button class="btn btn-md btn-info"><b>Verifikator</b></button> <button class="btn btn-md btn-warning"><b>Kontak Verifikator</b></button>
                <hr />
