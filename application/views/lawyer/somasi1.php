            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/lawyer') ?>">Tindakan Hukum</a></li>
                      ...
                      <div id="r1" class="modal fade" role="dialog">
                        <div class="modal-dialog modal-lg">
                          ...
                          <div class="modal-content">
                            ...
                            <form method="post" action="<?php echo base_url('lawyer/act_somasi1');?>">
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="number" name="jumlah_lampiran" class="form-control" id="pwd">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <textarea name="tempat_pertemuan" rows="5" class="form-control" id="pwd"></textarea>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="modal-dialog modal-lg">
                          ...
                          <div class="modal-content">
                            ...
                            <!-- body modal -->
                            <div class="modal-body">
                              <form method="post" action="<?php echo base_url('lawyer/act_somasi1_4');?>" enctype="multipart/form-data">
