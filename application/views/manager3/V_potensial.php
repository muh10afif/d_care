                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex align-items-center">
                            ...
                            <div><span>Estimate Sales</span>
                                <h4 class="font-medium mb-0">5489</h4></div>
                        </div>
                    </div>
                    <!-- col -->
                    <!-- col -->
...
<div class="row">
    ...
    <div class="col-lg-4 col-xl-6">
        <div class="card card-hover">
            <div class="card-body" style="background:url(<?= base_url() ?>template/assets/images/background/active-bg.png) no-repeat top center;">
                    ...
                    <table class="table no-wrap v-middle">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex no-block align-items-center">
                                        <div class="mr-2"><img src="<?= base_url() ?>template/assets/images/users/d1.jpg" alt="user" class="rounded-circle" width="45" /></div>
                                        <div class="">
                                ...
                                <td>
                                    <div class="popover-icon">
                                        ...
                                        <a class="btn-circle btn p-0 popover-item" href="javascript:void(0)"><img src="<?= base_url() ?>template/assets/images/users/1.jpg" class="rounded-circle" width="39"/></a>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex no-block align-items-center">
                                        <div class="mr-2"><img src="<?= base_url() ?>template/assets/images/users/d2.jpg" alt="user" class="rounded-circle" width="45" /></div>
                                        <div class="">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex no-block align-items-center">
                                        <div class="mr-2"><img src="<?= base_url() ?>template/assets/images/users/d3.jpg" alt="user" class="rounded-circle" width="45" /></div>
                                        <div class="">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex no-block align-items-center">
                                        <div class="mr-2"><img src="<?= base_url() ?>template/assets/images/users/2.jpg" alt="user" class="rounded-circle" width="45" /></div>
                                        <div class="">
        ...
        <div class="card">
            ...
            <div class="comment-widgets scrollable" style="height:560px;">
                ...
                <div class="d-flex flex-row comment-row mt-0">
                    <div class="p-2"><img src="<?= base_url() ?>template/assets/images/users/1.jpg" alt="user" width="50" class="rounded-circle"></div>
                ...
                <div class="d-flex flex-row comment-row">
                    <div class="p-2"><img src="<?= base_url() ?>template/assets/images/users/4.jpg" alt="user" width="50" class="rounded-circle"></div>
                ...
                <!-- Comment Row -->
                <div class="d-flex flex-row comment-row">
                    <div class="p-2"><img src="<?= base_url() ?>template/assets/images/users/5.jpg" alt="user" width="50" class="rounded-circle"></div>
                    <div class="comment-text w-100">
            ...
            <div class="card-body">
                ...
                <div class="chat-box scrollable position-relative" style="height:475px;">
                    ...
                    <ul class="chat-list">
                        <!--chat Row -->
                        <li class="chat-item">
                            <div class="chat-img"><img src="<?= base_url() ?>template/assets/images/users/1.jpg" alt="user"></div>
                        ...
                        <!--chat Row -->
                        <li class="chat-item">
                            <div class="chat-img"><img src="<?= base_url() ?>template/assets/images/users/2.jpg" alt="user"></div>
                            <div class="chat-content">
                        ...
                        <!--chat Row -->
                        <li class="chat-item">
                            <div class="chat-img"><img src="<?= base_url() ?>template/assets/images/users/3.jpg" alt="user"></div>
                            <div class="chat-content">
