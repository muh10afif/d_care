...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?= base_url();?>template/login/images/bg.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5" id="form-login" method="post" autocomplete="off">
					...
					<div class="wrap-input100 text-center" style="margin-top: -10px;">
                        ...
                        <h2 class="mb-2"><b style="color:#122E5D; font-size: 30px; font-weight: bold; text-shadow: 0.6px 0.5px 0.5px #000;">D - Care</b></h2>
                    </div>
                ...
                $.ajax({
                    ...
                    success     : function (data) {
                        ...
                        if (data.hasil == 'operator') {
                            ...
                            // }).then(function () {
                            //     var url = "<?= base_url('admin/operator') ?>";
                        ...
                        } else if(data.hasil == 'manager') {

                            var url = "<?= base_url('admin/manager') ?>";

                            window.location.href = url;

                        } else if(data.hasil == 'lawyer') {

                            var url = "<?= base_url('admin/lawyer') ?>";

                            window.location.href = url;

                        } else if(data.hasil == 'managerSyariah') {

                            
                            var url = "<?= base_url('admin/manager/syariah') ?>";

                            window.location.href = url;

                        } else if(data.hasil == 'lawyerSyariah') {

                           
                            var url = "<?= base_url('admin/lawyer/syariah') ?>";
                            ...
                            swal({
                                title 	: 'Gagal',
                                text 	: 'Anda tidak memiliki hak akses masuk!!',
                                type 	: 'error',
                                timer 	: 1000,
