                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="panel panel-default">
                            ...
                            <form class="form-horizontal" action="<?php echo site_url('Pengguna/act_edit');?>" method="post" enctype="multipart/form-data">
                              <input type="hidden" class="form-control" name="id_pengguna" value="<?php echo $get['id_pengguna']?>">
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control"  name="sha" value="<?php echo $get['sha']?>">
                                </div>
                                <div class="form-group">
                                ...
                                <?php echo anchor('pengguna/buat_pengguna','Kembali',array('class'=>'btn btn-danger btn-sm'))?>
                                </form>
                            </div>
                        </div>
                        <!-- /. PANEL  -->
